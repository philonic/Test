...
<%@page import="com.framework.common.web.Servlets"%>
<%@page import="com.framework.common.utils.Exceptions"%>
<%@page import="com.framework.common.utils.StringUtils"%>
...
<head>
	...
	<%@include file="/framework/views/include/head.jsp" %>
</head>
<body>
